...
CREATE TABLE IF NOT EXISTS review (
    ...
    product_id BIGINT NOT NULL, order_id BIGINT DEFAULT NULL,
    content TEXT NOT NULL, images JSON DEFAULT NULL,
    rating TINYINT NOT NULL DEFAULT 5,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    deleted TINYINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id), KEY idx_product_id (product_id), KEY idx_user_id (user_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品评价表';
...
CREATE TABLE IF NOT EXISTS banner (
    ...
    image_url VARCHAR(500) NOT NULL, link_url VARCHAR(500) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS coupon (
    ...
    discount DECIMAL(10,2) NOT NULL, min_amount DECIMAL(10,2) NOT NULL DEFAULT 0,
    total_stock INT NOT NULL DEFAULT 0, remain_stock INT NOT NULL DEFAULT 0,
    expire_days INT NOT NULL DEFAULT 7, status TINYINT NOT NULL DEFAULT 1,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS user_coupon (
    id BIGINT NOT NULL AUTO_INCREMENT, user_id BIGINT NOT NULL,
    coupon_id BIGINT NOT NULL, used TINYINT NOT NULL DEFAULT 0,
    expire_at DATETIME NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS announcement (
    id BIGINT NOT NULL AUTO_INCREMENT, title VARCHAR(200) NOT NULL,
    content TEXT NOT NULL, status TINYINT NOT NULL DEFAULT 1,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS feedback (
    id BIGINT NOT NULL AUTO_INCREMENT, user_id BIGINT NOT NULL,
    content TEXT NOT NULL, reply TEXT DEFAULT NULL, status TINYINT NOT NULL DEFAULT 0,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id), KEY idx_user_id (user_id)
